...
handler.before = async function (m) {
    ...
    if (!(id in this.siapakahaku)) return conn.sendButton(m.chat, '*Soal Itu Telah Berakhir*', author, ['𝐒𝐈𝐀𝐏𝐀𝐊𝐀𝐇 𝐀𝐊𝐔', '/siapakahaku'], m)
    if (m.quoted.id == this.siapakahaku[id][0].id) {
        ...
        if (m.text.toLowerCase() == json.jawaban.toLowerCase().trim()) {
            ...
            conn.sendButton(m.chat, `*✅ BENAR*\n+${this.siapakahaku[id][2]} XP`, author, ['𝐒𝐈𝐀𝐏𝐀𝐊𝐀𝐇 𝐀𝐊𝐔', '/siapakahaku'], m)
