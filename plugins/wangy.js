...
if (command == 'genjot') {
if (!text) throw `*[❗] Example: #genjot Clara*`
...
if (command == 'nenen') {
if (!text) throw `*[❗] Example: #nenen Clara*`
...
if (command == 'wangy') {
if (!text) throw `*[❗] Example: #wangy Clara*`
...
if (command == 'curhat') {
if (!text) throw `*[❗] Example: #curhat Clara*`
...
if (command == 'perkosa') {
if (!text) throw `*[❗] Example: #perkosa Clara*`
